...
//
//     final updateAdsModels = updateAdsModelsFromJson(jsonString);

import 'dart:convert';

UpdateAdsModels updateAdsModelsFromJson(String str) => UpdateAdsModels.fromJson(json.decode(str));

String updateAdsModelsToJson(UpdateAdsModels data) => json.encode(data.toJson());

class UpdateAdsModels {
    Data data;
    String status;
    String message;
    ...
    factory UpdateAdsModels.fromJson(Map<String, dynamic> json) => UpdateAdsModels(
